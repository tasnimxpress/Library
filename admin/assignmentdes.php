...
<?php
  ...
  $getBooks = $bk->editAssignmentIntoDB($_GET['id']);
?>
              ...
              <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="Ebook-1_content col-md-7 col-sm-12 leftpadd">
                      ...
                      <div class="herebooksubtitle">
                        ...
                        <div class="hereparts">
                          <p class="oritype"><span><i class="fas fa-clipboard"></i></span> Assignment</p>
                          <a href="#" class="btn previewbtn" tabindex="-1" role="button" aria-disabled="true">Preview</a>
                        </div>
                      
                     <!-- E-bbok describ  -->
                   <div class="E-book_1-describ">
                      <a class="E-book_1-describtion nowthis" href="" disabled>Description</a> 
                   </div>
                ...
                <div class="col-lg-2 resourcesidebar">
                   ...
                   <ul class="Ebook-1_resources">
                    ...
                    <li><a class="typesub" href="allassignment.php">Assignment</a></li>
