...
$bk = new VideoClasses();
  ...
  if ($_SERVER['REQUEST_METHOD']=="GET" && isset($_GET['id'])) {
    ...
    if ($_GET['id']!=null) {
        $editResult = $bk->editVideoIntoDB($_GET['id']);
    } else {
  ...
  if ($_SERVER['REQUEST_METHOD']=="POST" && isset($_POST['editBook'])) {
    ...
    if ($_GET['id']!=null) {
        $updateBookResult = $bk->updateVideoIntoDB($_POST,$_FILES,$_GET['id']);
    } else {
        echo "<script>window.location.href = '404.php';</script>";
    }
  }
        ...
        <div class="container-fluid dashboard">
          ...
          <form action="" method="POST" enctype="multipart/form-data">
            <div class="row formpart">
              ...
              <input type="text" class="form-control formclass" id="title" name="category" value="<?= isset($book['type']) ? $book['type'] : 'Video'; ?>" required>
              </div>
            </div>
            <div class="row formpart">
            ...
            <div class="row formpart">
              <label for="author" class="col-md-2 col-sm-12 col-form-label">Videographer:</label>
              <div class="col-md-8 col-sm-12">
              ...
              <div class="row formpart">
                <label for="cover" class="col-md-2 col-sm-12 col-form-label">Thumbnail:</label>
                <div class="col-md-8 col-sm-12">
              ...
              <div class="row formpart">
                ...
                <div class="col-md-8 col-sm-12">
                  <input type="file" accept="video/*" class="form-control formclass" id="fcover" name="fdocument" >
                </div>
              </div>
              <div class="row formpart">
