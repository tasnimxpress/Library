...
<?php
  ...
  if ($_SERVER['REQUEST_METHOD']=="POST" && isset($_POST['addreport'])) {
      ...
      $addBookResult = $bk->insertVideoIntoDB($_POST,$_FILES);
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            <div class="row formpart">
                ...
                <div class="col-md-8 col-sm-12">
                    <input type="text" class="form-control formclass" id="type" name="category" value="Video" required>
            ...
            <div class="row formpart">
                ...
                <div class="col-md-8 col-sm-12">
                    <input type="file" accept="video/*" class="form-control formclass" id="cover"
                        name="fdocument">
                </div>
            </div>
            <div class="row formpart">
                <input class="btn btncancel" type="reset" value="Cancel">
                <button class="btn btnsave" type="submit" name="addreport">Save</button>
            </div>
