...
<?php
  ...
  $dataList = $bk->getAssignment();

  if ($_SERVER['REQUEST_METHOD']=="GET" && isset($_GET['delete'])) {

    if ($_GET['delete']!=null) {
        $bk->deleteAssignmentIntoDB($_GET['delete']);
    } else {
          ...
          <div class="table-responsive scroll">
            ...
            <?php
              ...
              <tr>
                ...
                <td data-label="Title"><a href="assignmentdes.php?id=<?php echo $book['id']; ?>"><?php echo $book['title']; ?></a></td>
