        ...
        <div class="container-fluid dashboard">
          ...
          <form action="" method="POST" enctype="multipart/form-data">
            <div class="row formpart">
              ...
              <input type="text" class="form-control formclass" id="type" name="category" value="<?= isset($book['type']) ? $book['type'] : 'Book'; ?>" required>
              </div>
            </div>
            <div class="row formpart">
            ...
            <div class="row formpart">
              ...
              <div class="col-md-8 col-sm-12">
                <input type="number" class="form-control formclass" id="bookid" name="bookid" value="<?= isset($book['bookid']) ? $book['bookid'] : ''; ?>" required>
              </div>
            </div>
            <div class="row formpart">
                <label for="numberofcopy" class="col-md-2 col-sm-12 col-form-label">Number of Copy:</label>
                <div class="col-md-8 col-sm-12">
                  <input type="number" class="form-control formclass" id="numberofcopy" name="numberofcopy" value="<?= isset($book['quantity']) ? $book['quantity'] : ''; ?>" required>
                </div>
              </div>
              <div class="row formpart">
